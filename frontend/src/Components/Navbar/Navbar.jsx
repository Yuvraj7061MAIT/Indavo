...
import cart_icon from '../../assets/Assets/Frontend_Assets/cart_icon.png'; // Ensure this path is correct
  ...
  return (
    <div className="navbar">
      ...
      <ul className='nav-menu'>
        ...
        ><Link to='/' style={{textDecoration: 'none'}}><span>Shop</span></Link>
        ...
        ><Link to='/women' style={{textDecoration: 'none'}}><span>Women</span></Link>
        </li>
        <li 
          onClick={() => handleClick('kids')} 
          className={activeMenu === 'kids' ? 'underline active' : 'underline'}
        ><Link to='/kids' style={{textDecoration: 'none'}}><span>Kids</span></Link>
        </li>
      </ul>
      <div className="nav-cart">
        <div className="nav-cart-icon-container">
          <Link to='/cart' style={{textDecoration: 'none'}}><img src={cart_icon} alt="Cart" className="nav-cart-icon" /></Link>
